      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div>
            ...
            <ul className="text-sm space-y-2">
              ...
              <li>
                ...
                <a href="tel:+447446253967" className="hover:underline text-lg hover:text-[#13AFFE]">
                  +44 7446 253967
                </a>
              </li>
              <li>
                <span className="text-white font-semibold">Email:</span>{" "}
                <a href="mailto:crystal.cl34n@gmail.com" className="hover:underline text-lg hover:text-[#13AFFE]">
        ...
        <div className="mt-2 flex flex-col sm:flex-row justify-center items-center gap-3 text-center font-semibold text-gray-400">
          ...
          <div className="flex gap-4 text-sm">
            ...
            <a href="/privacy" className="hover:text-[#13AFFE] transition duration-300">
              Privacy Policy
            </a>
          </div>
