  ...
  return (
    <section className="bg-black text-white mx-auto px-4 py-8">
          <div className="max-w-6xl mx-auto">
              <h1 className="text-3xl font-semibold text-center mb-6 pt-20">Website Terms of Use</h1>
              ...
              <div className="mt-8 space-y-6">
                  ...
                  <section>
                      ...
                      <div className="text-white">
                          <p><strong>Crystal Clean</strong></p>
                          <p>Email: <a href="mailto: crystal.cl34n@gmail.com" className="text-[#861918] hover:underline"> crystal.cl34n@gmail.com</a></p>
                          <p>Phone: +44 7446 253967</p>
