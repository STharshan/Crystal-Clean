                    ...
                    <div className="space-y-3">
                        {contactLinks?.map((link, index) => (
                            ...
                            >
                                ...
                                <h6 className="text-base font-semibold group-hover:text-[#0A7BDF] transition-colors">
                                    {link.title}
                                </h6>
                            </a>
                        ))}
                ...
                <div className="flex flex-col gap-10 mt-10 lg:mt-0">
                    {packages?.map((pkg, idx) => (
                        <div
                            ...
                            bg-white dark:bg-[#151515] hover:border-[#0A7BDF]/40 shadow-sm hover:shadow-xl"
                        >
